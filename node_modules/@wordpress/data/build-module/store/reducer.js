...
var subKeysIsResolved = flowRight([onSubKey('reducerKey'), onSubKey('selectorName')])(function () {
...
var isResolved = function isResolved() {
  ...
  switch (action.type) {
    case 'INVALIDATE_RESOLUTION_FOR_STORE':
      return has(state, action.reducerKey) ? omit(state, [action.reducerKey]) : state;

    case 'INVALIDATE_RESOLUTION_FOR_STORE_SELECTOR':
      return has(state, [action.reducerKey, action.selectorName]) ? _objectSpread({}, state, _defineProperty({}, action.reducerKey, omit(state[action.reducerKey], [action.selectorName]))) : state;
